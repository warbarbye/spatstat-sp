...
## Rysowanie prostych obiektów geometrycznych
...
plot_points = function(.num, .package = "sp") { 
...
#sp_benchmark = list(small = do_benchmark(plot_points, 10),
#                    medium = do_benchmark(plot_points, 1000),
#                    large = do_benchmark(plot_points, 100000))
